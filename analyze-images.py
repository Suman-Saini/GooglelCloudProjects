...
# client = vision_v1.services.image_annotator.ImageAnnotatorClient()
...
for file in files:
    if file.name.endswith('jpg') or file.name.endswith('png'):
        ...
        image_object = vision_v1.types.Image()
        ...
        response = vision_client.annotate_image({
            'image': image_object,
            'features': [{'type': vision_v1.types.Feature.Type.TEXT_DETECTION}]
        })
